...
class SOQL_Querying:
    def __init__(self, dataset_url: str, app_token: str = None):
        domain = re.search(r"https?://([^/]+)", dataset_url).group(1)
        view_id = re.search(r"([a-z0-9]{4}-[a-z0-9]{4})", dataset_url, re.I).group(1)
